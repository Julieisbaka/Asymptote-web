...
def strokes(
    *segments: tuple[float, float, float, float],
...
GLYPH_STROKES: dict[str, tuple[tuple[float, float, float, float], ...]] = {
    " ": (),
    "0": strokes(
        (0, 0, 5, 0),
        (5, 0, 5, 7),
    ...
    "5": strokes(
        (5, 7, 0, 7), (0, 7, 0, 3.5), (0, 3.5, 5, 3.5), (5, 3.5, 5, 0), (5, 0, 0, 0)
    ),
    "6": strokes(
        (5, 7, 0, 7), (0, 7, 0, 0), (0, 0, 5, 0), (5, 0, 5, 3.5), (5, 3.5, 0, 3.5)
    ),
    "7": strokes((0, 7, 5, 7), (5, 7, 0, 0)),
    "8": strokes(
        (0, 0, 5, 0), (5, 0, 5, 7), (5, 7, 0, 7), (0, 7, 0, 0), (0, 3.5, 5, 3.5)
    ),
    ...
    "G": strokes(
        (5, 7, 0, 7), (0, 7, 0, 0), (0, 0, 5, 0), (5, 0, 5, 3), (5, 3, 2.5, 3)
    ),
    ...
    "R": strokes(
        (0, 0, 0, 7), (0, 7, 5, 7), (5, 7, 5, 3.5), (5, 3.5, 0, 3.5), (2.5, 3.5, 5, 0)
    ),
    "S": strokes(
        (5, 7, 0, 7), (0, 7, 0, 3.5), (0, 3.5, 5, 3.5), (5, 3.5, 5, 0), (5, 0, 0, 0)
    ),
    ...
    "W": strokes(
        (0, 7, 1.25, 0), (1.25, 0, 2.5, 4), (2.5, 4, 3.75, 0), (3.75, 0, 5, 7)
    ),
    ...
    "h": strokes(
        (0.5, 7, 0.5, 0), (0.5, 3.5, 2, 4), (2, 4, 4.5, 3.5), (4.5, 3.5, 4.5, 0)
    ),
    ...
    "n": strokes(
        (0.5, 4, 0.5, 0), (0.5, 3.5, 2, 4), (2, 4, 4.5, 3.5), (4.5, 3.5, 4.5, 0)
    ),
    "o": strokes(
        (1, 4, 4, 4),
        (4, 4, 4.5, 3.5),
    ...
    "u": strokes(
        (0.5, 4, 0.5, 0.5), (0.5, 0.5, 2, 0), (2, 0, 4.5, 0.5), (4.5, 4, 4.5, 0)
    ),
    "v": strokes((0.5, 4, 2.5, 0), (2.5, 0, 4.5, 4)),
    "w": strokes(
        (0.5, 4, 1.5, 0), (1.5, 0, 2.5, 2.5), (2.5, 2.5, 3.5, 0), (3.5, 0, 4.5, 4)
    ),
    ...
    "?": strokes(
        (0, 6, 1, 7), (1, 7, 4, 7), (4, 7, 5, 6), (5, 6, 2.5, 3.5), (2.5, 3.5, 2.5, 2)
    ),
    ":": strokes((2.5, 5, 2.5, 5), (2.5, 1, 2.5, 1)),
    ";": strokes((2.5, 5, 2.5, 5), (2.5, 1, 2, 0)),
    "'": strokes((2.5, 7, 2.5, 5)),
    '"': strokes((1.5, 7, 1.5, 5), (3.5, 7, 3.5, 5)),
    "-": strokes((1, 3.5, 4, 3.5)),
    "+": strokes((2.5, 1, 2.5, 6), (0, 3.5, 5, 3.5)),
    "=": strokes((0, 4.5, 5, 4.5), (0, 2.5, 5, 2.5)),
    "/": strokes((0, 0, 5, 7)),
    "(": strokes((4, 7, 1, 5), (1, 5, 1, 2), (1, 2, 4, 0)),
    ")": strokes((1, 7, 4, 5), (4, 5, 4, 2), (4, 2, 1, 0)),
    "^": strokes((1, 5, 2.5, 7), (2.5, 7, 4, 5)),
    "_": strokes((0, 0, 5, 0)),
    "|": strokes((2.5, 0, 2.5, 7)),
    "\\": strokes((0, 7, 5, 0)),
